        ...
        while True:
            ...
            try:
                ...
                system_instruction = (
                    ...
                    "3. 'python_interpreter' tool: Call this tool to execute Python code in the sandbox. "
                    "CRITICAL: Listen when a Python program is detected in the user's query, then call the tool automatically to run it. "
                    "If needed or explicitly asked, show the code in your chat response. Otherwise, just provide a concise summary of the execution results in the chat window. "
                    "Always write the code inside the tool call argument when invoking it.\n"
